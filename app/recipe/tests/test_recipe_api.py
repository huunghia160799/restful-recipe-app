...
def image_upload_url(recipe_id):
    """Return URL for recipe image uploaded"""
...
class PrivateRecipeApiTests(TestCase):
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        ingredient1 = sample_ingredient(self.user, 'Prawn')
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_tags(self):
        ...
        tag2 = sample_tag(user=self.user, name='Vegatarian')
    ...
    def test_filter_recipes_by_ingredient(self):
        ...
        recipe2 = sample_recipe(user=self.user, title='Chicken caccitore')
